// Drawer Organiser — front piece of the back-right container (4 x 6 cells)
// Render this file to generate drawer_container_back_4x6_right_front.stl
// 186.25 x 125.75mm — cells [0,3) of the container's 6-cell depth, cut at
// cell 3 (rows 7|8 of the drawer, 1-based) so the cut face meets its partner
// over the middle of the back baseplate tile while this piece straddles the
// tile seam at rows 5|6 (issues #319/#322). Print together with
// drawer_container_back_4x6_right_back to assemble the full 168 x 252 x 69mm
// back-right container.
//
