// Drawer Organiser — centre piece of the back container (12 x 3 cells)
// Render this file to generate drawer_container_back_centre.stl
// 210.0 x 125.5mm — cells [4,9) of the container's 12-cell width, split
...
// drawer_container_back_left and drawer_container_back_right to assemble the
// full 504 x 126 x 56mm back container.
//
