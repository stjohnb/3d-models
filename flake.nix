          ...
          default = pkgs.mkShell {
            packages = [
              ...
              (python3.withPackages (ps: with ps; [
                ...
                pillow # scripts/image_metadata.py (+ tests, CI-enforced); fetch_terrain_heightmap.py PNG decode
                requests # scripts/fetch_terrain_heightmap.py tile fetch
                pytest # AGENTS.md / .agents/issue-implementer.md documented `python3 -m pytest scripts/`
              ]))
